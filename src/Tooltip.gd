# Modified from https://github.com/IndieQuest/Modular-tooltip/blob/master/Tooltip.gd
class_name Tooltip
extends Node
...
var _visuals: TowerLabel
var _timer: Timer

var visuals_res = preload("res://src/TowerLabel.tscn")
